...
SETTINGS = {"system": "SR", "vendor": "华三", "device_type": "SR", "vendor_id": "h3c", "device_id": "sr"}
...
OPERATIONS = [
    ...
    {"name": "查看Route-Aggregation子接口配置", "fields": [("subinterface", "Route-Aggregation子接口编号", "17.97703000")], "commands": ["display current-configuration interface Route-Aggregation {subinterface}"]},
    ...
    {"name": "全局查看子接口ARP表", "fields": [("subinterface", "Route-Aggregation子接口编号", "17.97703000")], "commands": ["display arp interface Route-Aggregation {subinterface}"]},
    {"name": "VPN业务子接口查看ARP表", "fields": [("subinterface", "Route-Aggregation子接口编号", "17.97703000")], "commands": ["display arp interface Route-Aggregation {subinterface}"]},
]
