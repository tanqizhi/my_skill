...
SEARCHES = {
    "username": [
        {"name": "基于username查看用户是否在线", "fields": [("username", "用户名", "")], "commands": ["display access-user username {username}"]},
        {"name": "基于username查看用户上线失败记录", "fields": [("username", "用户名", "")], "commands": ["display aaa online-fail-record username {username}"]},
        {"name": "基于username查看用户下线记录", "fields": [("username", "用户名", "")], "commands": ["display aaa offline-fail-record username {username}"]},
    ],
    "user_ip": [
        {"name": "基于用户IP地址查看用户是否在线", "fields": [("user_ip", "用户IP地址", "")], "commands": ["display access-user ip-address {user_ip}"]},
    ],
    "mac": [
        {"name": "基于用户MAC地址查看用户是否在线", "fields": [("mac", "用户MAC地址", "")], "commands": ["display access-user mac-address {mac}"]},
        {"name": "基于用户MAC地址查看用户上线失败记录", "fields": [("mac", "用户MAC地址", "")], "commands": ["display aaa online-fail-record mac-address {mac}"]},
        {"name": "基于用户MAC地址查看用户下线记录", "fields": [("mac", "用户MAC地址", "")], "commands": ["display aaa offline-fail-record mac-address {mac}"]},
    ],
}
